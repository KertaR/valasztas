            ...
            <AnimatePresence mode="popLayout">
                {candidates.map((jelolt, idx) => (
                    <motion.div
                        ...
                        className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm hover:shadow-xl border border-slate-200/60 dark:border-slate-800/60 p-5 cursor-pointer group transition-all duration-300 hover:-translate-y-1 relative overflow-hidden flex flex-col h-full"
                    >
                        {/* Decorative background element for the card */}
                        <div className="absolute -top-10 -right-10 w-32 h-32 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-3xl group-hover:bg-blue-500/10 dark:group-hover:bg-blue-500/20 transition-all duration-500"></div>

                        <div className="flex justify-between items-start mb-5 relative z-10">
                            <div className="w-16 h-16 rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100 to-indigo-50 dark:from-blue-900/40 dark:to-indigo-900/20 text-blue-700 dark:text-blue-300 flex items-center justify-center font-black text-xl shadow-md border border-white/50 dark:border-slate-700/50 group-hover:scale-105 group-hover:shadow-lg transition-transform relative">
                                {jelolt.fenykep ? (
                                    <img
                        ...
                        <div className="flex-1 flex flex-col relative z-10">
                            ...
                            <div className="mt-auto space-y-3">
                                <div className="flex items-start gap-2.5 bg-slate-50 dark:bg-slate-800/40 p-3 rounded-xl border border-slate-100 dark:border-slate-800/60">
